...
@section('title', 'Spark - Shoes Store')
@section('meta_description', 'Spark - premium shoes store landing page')
                ...
                <ul
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-black text-white" aria-labelledby="pages">
                      <li><a href="#" class="dropdown-item text-white">About Us <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Shop <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Single Product <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Cart <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Checkout <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Blog <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Single Post <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Styles <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Contact <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">Thank You <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">My Account <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                      <li><a href="#" class="dropdown-item text-white">404 Error <span
                            class="badge bg-warning text-dark ms-2">PRO</span></a></li>
                    </ul>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="https://templatesjungle.gumroad.com/l/spark-shoe-store-template" class="nav-link bg-black text-white rounded-pill px-3">Get PRO</a>
                  </li>
                </ul>
      ...
      <div
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide jarallax swiper-slide-next">
            ...
            <img src="{{ asset('frontend/images/slide-2.jpg') }}" class="jarallax-img" alt="slideshow">
          ...
          <div class="swiper-slide jarallax">
            ...
            <img src="{{ asset('frontend/images/slide-3.jpg') }}" class="jarallax-img" alt="slideshow">
            <div class="banner-content w-100">
              <div class="container-fluid">
                <div class="row justify-content-center text-center">
                  <div class="col-md-10 pt-5">
          ...
          <div class="swiper-slide jarallax">
            ...
            <img src="{{ asset('frontend/images/slide-4.jpg') }}" class="jarallax-img" alt="slideshow">
            <div class="banner-content w-100">
              <div class="container-fluid">
                <div class="row justify-content-center text-center">
                  <div class="col-md-10 pt-5">
          ...
          <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
              ...
              <div class="product-item">
                ...
                <figure>
                  <a href="#" title="Product Title">
                    <img src="{{ asset('frontend/images/product-thumb-1.png') }}" alt="Product Thumbnail" class="img-fluid">
                  </a>
                </figure>
            ...
            <div class="col">
              <div class="product-item">
                ...
                <figure>
                  <a href="#" title="Product Title">
                    <img src="{{ asset('frontend/images/product-thumb-2.png') }}" alt="Product Thumbnail" class="img-fluid">
                  </a>
                </figure>
            ...
            <div class="col">
              <div class="product-item">
                ...
                <figure>
                  <a href="#" title="Product Title">
                    <img src="{{ asset('frontend/images/product-thumb-3.png') }}" alt="Product Thumbnail" class="img-fluid">
                  </a>
                </figure>
            ...
            <div class="col">
              <div class="product-item">
                <figure>
                  <a href="#" title="Product Title">
                    <img src="{{ asset('frontend/images/product-thumb-4.png') }}" alt="Product Thumbnail" class="img-fluid">
                  </a>
                </figure>
            ...
            <div class="col">
              <div class="product-item">
                <figure>
                  <a href="#" title="Product Title">
                    <img src="{{ asset('frontend/images/product-thumb-5.png') }}" alt="Product Thumbnail" class="img-fluid">
                  </a>
                </figure>
            ...
            <div class="col">
              <div class="product-item">
                <figure>
                  <a href="#" title="Product Title">
                    <img src="{{ asset('frontend/images/product-thumb-6.png') }}" alt="Product Thumbnail" class="img-fluid">
                  </a>
                </figure>
                <span>Super Shoes</span>
                <div class="d-flex justify-content-between">
            ...
            <div class="col">
              <div class="product-item">
                <figure>
                  <a href="#" title="Product Title">
                    <img src="{{ asset('frontend/images/product-thumb-7.png') }}" alt="Product Thumbnail" class="img-fluid">
                  </a>
                </figure>
                <span>Super Shoes</span>
                <div class="d-flex justify-content-between">
