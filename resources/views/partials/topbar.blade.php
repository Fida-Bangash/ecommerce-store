...
<header class="navbar-custom">
  ...
  <div class="navbar-search-wrapper">
    <input type="text" class="navbar-search-input" placeholder="Search anything in {{ config('app.name') }}..." id="main-search">
  ...
  <div class="navbar-actions">
    ...
    <div class="dropdown ms-2">
      <button class="navbar-profile-btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
        ...
        <span class="navbar-profile-name d-none d-md-inline">{{ auth()->check() ? auth()->user()->name : 'Administrator' }}</span>
        <i class="bi bi-chevron-down navbar-profile-caret"></i>
      </button>
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-profile" aria-labelledby="profile-dropdown">
        <li class="dropdown-header">Welcome, {{ auth()->check() ? auth()->user()->name : 'Administrator' }} !</li>
        <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="bi bi-person"></i> My Account</a></li>
        <li>
          <hr class="dropdown-divider">
        </li>
        <li>
